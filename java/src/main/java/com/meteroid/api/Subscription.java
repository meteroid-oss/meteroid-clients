...
public class Subscription {
    ...
    public Subscription(MeteroidHttpClient client) {
        this.client = client;
    }
    ...
    public SubscriptionListResponse listSubscriptions() throws IOException, ApiException {
        ...
        return this.listSubscriptions(new SubscriptionListSubscriptionsOptions());
    }

    /** List subscriptions with optional filtering by customer or plan. */
    public SubscriptionListResponse listSubscriptions(
            final SubscriptionListSubscriptionsOptions options) throws IOException, ApiException {
