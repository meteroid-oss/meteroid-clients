...
public class ProductFamily {
    ...
    public ProductFamily(MeteroidHttpClient client) {
        this.client = client;
    }
    ...
    public ProductFamilyListResponse listProductFamilies() throws IOException, ApiException {
        ...
        return this.listProductFamilies(new ProductFamilyListProductFamiliesOptions());
    }

    /** */
    public ProductFamilyListResponse listProductFamilies(
            final ProductFamilyListProductFamiliesOptions options)
