...
public class PlanListResponse {
    @JsonProperty private List<Plan> data;
    ...
    public PlanListResponse paginationMeta(PaginationResponse paginationMeta) {
     ...
     * @return An instance of PlanListResponse
     * @throws JsonProcessingException if the JSON string is invalid with respect to
     *     PlanListResponse
     */
    public static PlanListResponse fromJson(String jsonString) throws JsonProcessingException {
        return Utils.getObjectMapper().readValue(jsonString, PlanListResponse.class);
    }

    /**
     * Convert an instance of PlanListResponse to an JSON string
     *
     * @return JSON string
     */
