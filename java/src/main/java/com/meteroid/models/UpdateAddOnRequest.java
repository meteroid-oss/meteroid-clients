...
public class UpdateAddOnRequest {
    ...
    public UpdateAddOnRequest description(String description) {
    ...
    public UpdateAddOnRequest maxInstancesPerSubscription(Integer maxInstancesPerSubscription) {
    ...
    public UpdateAddOnRequest priceId(String priceId) {
    ...
    public UpdateAddOnRequest selfServiceable(Boolean selfServiceable) {
     ...
     *     UpdateAddOnRequest
     */
    public static UpdateAddOnRequest fromJson(String jsonString) throws JsonProcessingException {
        return Utils.getObjectMapper().readValue(jsonString, UpdateAddOnRequest.class);
    }
