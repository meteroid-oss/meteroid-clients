...
type SubscriptionDetails struct {
	...
	AddOns RequiredSlice[SubscriptionAddOn] `json:"add_ons"`

	AppliedCoupons RequiredSlice[AppliedCouponDetailed] `json:"applied_coupons"`
	...
	Components RequiredSlice[SubscriptionComponent] `json:"components"`
